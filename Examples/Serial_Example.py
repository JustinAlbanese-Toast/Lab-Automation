...
try:
    ...
    session.set_visa_attribute(pyvisa.constants.VI_ATTR_ASRL_PARITY, pyvisa.constants.VI_ASRL_PAR_NONE)
    session.set_visa_attribute(pyvisa.constants.VI_ATTR_ASRL_FLOW_CNTRL, pyvisa.constants.VI_ASRL_FLOW_DTR_DSR)
